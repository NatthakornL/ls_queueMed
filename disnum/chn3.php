    ...
    <form method="post" action="" enctype="multipart/form-data">
        ...
        <div id="centered">
            ...
            if (mysqli_num_rows($result) == 0) {
                ...
                $ins = "INSERT INTO queueMedDoc (id, q_sum, q_chn1, q_chn2, q_chn3, chk_date) VALUES ('$id', 0, 0, 0, 0, '$chkdate')";
                mysqli_query($connect, $ins) or die(mysqli_error($connect));
            }

            // Fetch the record
            $sql = "SELECT * FROM queueMedDoc WHERE chk_date = '$chkdate' limit 1";
            ...
            if ($result->num_rows > 0) {
                ...
                if (isset($_POST['increment3'])) {
                    ...
                    $up = "UPDATE queueMedDoc SET q_chn3 = $q_chn3 WHERE chk_date = '$chkdate'";
